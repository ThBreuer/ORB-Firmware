...
{
//  PinConfig::set( GPIOA, 9, // TODO hard coded port pin!
//                     PinConfig::INPUT|PinConfig::NO_PUPD,
//                     0 );

//  PinConfig::set( PinConfig::OTG_FS_ID, PinConfig::PULL_UP
//                                             |PinConfig::HIGH_SPEED
//                                             |PinConfig::OPEN_DRAIN );

  PinConfig::set( PinConfig::OTG_FS_DM, PinConfig::NO_PUPD
                                             |PinConfig::HIGH_SPEED
                                             |PinConfig::PUSH_PULL );

  PinConfig::set( PinConfig::OTG_FS_DP, PinConfig::NO_PUPD
                                             |PinConfig::HIGH_SPEED
                                             |PinConfig::PUSH_PULL);
