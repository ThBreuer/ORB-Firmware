    ...
    */
    class Device
    {
      public:
        ...
        */
        template <class A>
        void read( A addr, BYTE *data, BYTE size )
        {
          isErrorFlag |= i2c.read( hwAddr, (BYTE *)&addr, sizeof(A), data, size );
        }
        ...
        */
        template <class A> 
        void write( A addr, BYTE *data, BYTE size )
        {
          isErrorFlag |= i2c.write( hwAddr, (BYTE *)&addr, sizeof(A), data, size );
        }
