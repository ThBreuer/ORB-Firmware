...
//    >php -f USB_Descriptor_Script.php Src\descriptor.txt USBdeviceDescriptor_0
//
//###################################################################
...
class USBdeviceDescriptor_0 : public USBdeviceDescriptor
{
  ...
  public:
                                       ...
                                       BYTE ID )
    {
      switch( getId( typeID, confID, interfID, ID ) )
      {
        ...
        case 0x6002: return( DataPointer( ( BYTE* )&descriptor[ 66], 34 ) ); // String
        case 0x6003: return( DataPointer( ( BYTE* )&descriptor[100], 14 ) ); // String
        case 0x6004: return( DataPointer( ( BYTE* )&descriptor[114], 10 ) ); // String
        case 0x6005: return( DataPointer( ( BYTE* )&descriptor[124], 18 ) ); // String
        case 0x60EE: return( DataPointer( ( BYTE* )&descriptor[142], 18 ) ); // String
        case 0x7000: return( DataPointer( ( BYTE* )&descriptor[160], 40 ) ); // Compat
      }
      return( DataPointer(  ) );
    }
  ...
  private:
    //---------------------------------------------------------------
    static const BYTE          descriptor[201];
...
//
//-------------------------------------------------------------------
const BYTE USBdeviceDescriptor_0::descriptor[201] =
{
  ...
  // DEVICE
    ...
    /* bDeviceProtocol    */ 0,
    /* bMaxPacketSize0    */ 64,
    /* idVendor           */ (0x0023)&0xFF, (0x0023)>>8,
    /* idProduct          */ (0x2000)&0xFF, (0x2000)>>8,
    /* bcdDevice          */ (0x0000)&0xFF, (0x0000)>>8,
    /* iManufacturer      */ 0x01,
    /* iProduct           */ 0x02,
    /* iSerialNumber      */ 0x03,
